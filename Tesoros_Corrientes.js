...
function cambiarImagenSeleccionadaTesoro2() {
 ...
 // Función para barajar y poner la imagen de trasera del tesoro
        function barajarTesoros() {
          	document.getElementById('imagen-tesoro').src = 'img/Trasera tesoro corriente.png';
		document.getElementById('imagen-tesoro-1').src = 'img/Trasera tesoro corriente.png';
		document.getElementById('imagen-tesoro-2').src = 'img/Trasera tesoro corriente.png';
        }
